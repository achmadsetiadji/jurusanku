      ...
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <main className="flex-1 pt-24 pb-12">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-2xl mx-auto mb-12 p-6 rounded-2xl bg-gradient-to-br from-primary/10 via-card to-accent/10 border border-primary/20">
              <div className="text-center">
                <p className="text-sm font-medium text-primary mb-2">Rekomendasi Terbaik</p>
                <div className="text-5xl mb-4">{topResult.major.icon}</div>
                <h2 className="text-2xl md:text-3xl font-bold mb-2">{topResult.major.name}</h2>
                <div className="flex items-center justify-center gap-4 text-muted-foreground">
                  <span className="text-4xl font-bold text-primary">{topResult.percentage}%</span>
            ...
            <div className="max-w-4xl mx-auto">
              <h3 className="text-xl font-semibold mb-6">Semua Rekomendasi</h3>
